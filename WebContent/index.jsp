        ...
        <ul>
         ...
         <li><a href="#about">About Us</a></li>
          <li class="drop-down"><a href="">Login</a>
            <ul>
             	<li><a onclick="document.getElementById('id01').style.display='block'">Admin Login</a></li>
                  <li><a onclick="document.getElementById('id01').style.display='block'">User Login</a></li>
              </ul>
          </li>
        </ul>
      </nav><!-- .main-nav -->
  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-info">
        <h2>We provide<br><span>Certificates</span><br>for your Identity!</h2>
        <div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-5 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title"><a onclick="document.getElementById('id01').style.display='block'"></a></h4>
            </div>
          </div>
        </div>
