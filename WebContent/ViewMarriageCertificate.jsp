...
<section id="intro" class="section-bg" style="margin-top: -20px;">
      <div class="container" style="background-color: white;padding-top: 10px;">
        ...
        <div class="title text-center brder" style="margin-bottom: 10px;">
					<h1 class="mb-10"><i class="fa fa-user">&nbsp;MARRIAGE DETAILS</h1></i>
				</div>
        <div class="row">
            ...
            <div class="box">
             <form role="form">
                          <sql:setDataSource
        					...
        					url="jdbc:mysql://localhost:3306/onlinecertificate"
        					user="root"
        					password="" />
        ...
        <th>ID</th>
        	...
        	<tr  style="color: black">
        		...
        		<td><c:out value="${rows.HusbandFirstName}" /></td>
        		<td><c:out value="${rows.HusbandLastName}" /></td>
        		<td><c:out value="${rows.WifeFirstName}" /></td>
        		<td><c:out value="${rows.WifeLastName}" /></td>
        		<td><c:out value="${rows.HusbandHouseNo},${rows.HusbandHouseName},${rows.HusbandHouseArea},${rows.HusbandCity}" /></td>
        		<td><c:out value="${rows.HusbandReligion}" /></td>
        		<td><c:out value="${rows.HusbandOccupation}" /></td>
        		<td><c:out value="${rows.WifeOccupation}" /></td>
        		<td><c:out value="${rows.Husbandcontact}" /></td>
        		<td><a href="GenerateMarriageCertificate.jsp?Id=<c:out value="${rows.id}" />"><u><font  color="green"> Generate Certificate</font></u></a></td>   
