...
<section id="intro" class="section-bg" style="margin-top: -20px;">
      <div class="container" style="background-color: white;padding-top: 10px;">
        ...
        <div class="title text-center brder" style="margin-bottom: 10px;">
					<h1 class="mb-10"><i class="fa fa-user">&nbsp;BIRTH DETAILS</h1></i>
				</div>
        <div class="row">
        ...
        <th>ID</th>
        	...
        	<tr  style="color: black">
        		...
        		<td><c:out value="${rows.BirthFirstName}" /></td>
        		<td><c:out value="${rows.BirthMiddleName}" /></td>
        		<td><c:out value="${rows.BirthLastName}" /></td>
        		<td><c:out value="${rows.Gender}" /></td>
        		<td><c:out value="${rows.BirthFatherName}" /></td>
        		<td><c:out value="${rows.BirthFatherLastName}" /></td>
        		<td><c:out value="${rows.BirthMotherName}" /></td>
        		<td><c:out value="${rows.BirthMotherLastName}" /></td>
        		<td><c:out value="${rows.BirthPlace}" /></td>
        		<td><c:out value="${rows.BirthDate}" /></td>
        		<td><a href="GenerateBirthCertificate.jsp?Id=<c:out value="${rows.id}" />"><u><font  color="green"> Generate Certificate</font></u></a></td>   
