  ...
  <form class="modal-content animate contactForm" action="DeathCertificate" method="POST">
    <div class="container">
 				<div class="title text-center brder">
					<h2 class="mb-10"><i class="fa fa-user">&nbsp;Death Certificate Form</h2></i>
				</div>
				<br>
  				 <div class="form-row">
				...
				<div class="form-row">
                  ...
                  <div class="form-group col-lg-4">
                    <input type="text" name="MiddleName" class="form-control" id="MiddleName" placeholder="Middle Name" data-rule="minlen:4" data-msg="Please Enter Your Middle Name" />
                    <div class="validation"></div>
                  </div>
                <div class="form-group col-lg-4">
				...
				<div class="form-row">
					<h4>Birth Date :</h4>
  				  <div class="form-group col-lg-4">
                    <input type="date" name="BirthDate" class="form-control" id="BirthDate" placeholder="Birth Date" data-rule="minlen:4" data-msg="Please Select Birth Date" />
                    <div class="validation"></div>
                  </div>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h5>Death Date :</h5>
                  <div class="form-group col-lg-4">
                    <input type="date" name="DeathDate" class="form-control" id="DeathDate" placeholder="Death Date" data-rule="minlen:4" data-msg="Please Select Death Date" />
                    <div class="validation"></div>
                  </div>
                  </div>
                <div class="form-row">
                ...
                <div class="form-group col-lg-6">
                    <input type="text" name="DeathPlace" class="form-control" id="DeathPlace" placeholder="Death Place" data-rule="minlen:4" data-msg="Please Enter Death Place" />
                    <div class="validation"></div>
                  </div>
                  </div>
