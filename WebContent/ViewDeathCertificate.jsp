...
<section id="intro" class="section-bg" style="margin-top: -20px;">
      <div class="container" style="background-color: white;padding-top: 10px;">
        ...
        <div class="title text-center brder" style="margin-bottom: 10px;">
					<h1 class="mb-10"><i class="fa fa-user">&nbsp;DEATH DETAILS</h1></i>
				</div>
        <div class="row">
        ...
        <th>ID</th>
        	...
        	<tr  style="color: black">
        		...
        		<td><c:out value="${rows.DeathDate}" /></td>
        		<td><c:out value="${rows.BirthPlace}" /></td>
        		<td><c:out value="${rows.DeathPlace}" /></td>
        		<td><a href="GenerateDeathCertificate.jsp?Id=<c:out value="${rows.id}" />"><u><font  color="green"> Generate Certificate</font></u></a></td>   
